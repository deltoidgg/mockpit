...
hoistedDependencies:
  ...
  '@vitest/mocker@4.1.6(msw@2.14.6(@types/node@24.12.4)(typescript@5.9.3))(vite@7.3.3(@types/node@24.12.4))':
  ...
  esutils@2.0.3:
    esutils: private
  examples/vite-basic:
    '@mockkit/example-vite-basic': private
  expect-type@1.3.0:
    expect-type: private
  ...
  packages/browser:
    '@mockkit/browser': private
  packages/core:
    '@mockkit/core': private
  packages/devtools:
    '@mockkit/devtools': private
  packages/msw:
    '@mockkit/msw': private
  parent-module@1.0.1:
...
pendingBuilds: []
prunedAt: Wed, 13 May 2026 12:57:40 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - '@turbo/windows-64@2.9.12'
  - '@turbo/windows-arm64@2.9.12'
storeDir: /Users/expectai/Library/pnpm/store/v3
